...
function Card({ i, x, y, rot, scale, trans, bind, data }) {
  ...
  function checkmark(yn) {
    if (yn) {
      return (<svg class="mr-1" width="17" height="17" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      return (<svg class="mr-1" width="17" height="17" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          <div className="card" >
            ...
            <div className="bottomCard" onClick={() => set(state => !state)} {...bind(i)}>
              ...
              <p class="w-1/2">{'Reviews: '+review_count}</p>
              {stars(rating)}
              </div>
              <div class="flex justify-between w-full">
              <p class="w-1/2">{'Price: '+price}</p>
              <p class="w-1/2 flex">
              {transactions ? checkmark(transactions.includes("pickup")) : ' n/a'}
              Pick up
              </p>
              </div>
              <div class="flex justify-between w-full">
              <p class="w-1/2">{'X miles away'}</p>
              <p class="w-1/2 flex">
              {transactions ? checkmark(transactions.includes("delivery")) : ' n/a'}
              Delivery
              </p>
              </div>
            </div>
