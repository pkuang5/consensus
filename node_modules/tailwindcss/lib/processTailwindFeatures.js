...
function _default(getConfig) {
  return function (css) {
    ...
    if (!flagsIssued || !_lodash.default.isEqual(flagsIssued, _lodash.default.pick(config, ['future', 'experimental']))) {
      flagsIssued = _lodash.default.pick(config, ['future', 'experimental']);
